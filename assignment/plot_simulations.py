...
for i in range(len(logT_1)-1):
	...
	if i == 1:
		ax.plot(x_1, y_1, color = colorVal_1,lw=1,ls='--',label=r'$1M_{Sun}$')
		ax.plot(x_2, y_2, color = colorVal_2,lw=1,label=r'$2M_{Sun}$')

	ax.plot(x_1, y_1, color = colorVal_1,lw=1,ls='--')
	ax.plot(x_2, y_2, color = colorVal_2,lw=1)
